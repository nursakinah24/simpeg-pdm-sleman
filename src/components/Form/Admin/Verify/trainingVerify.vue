...
export default {
    ...
    setup(props, { emit }) {
        ...
        status_verifikasi.value = props.trainData.status_verifikasi;
        alasan_ditolak.value = props.trainData.alasan_ditolak || '';
        itemId.value = props.trainData.id;

        const handleSubmit = async () => {
            try {
                loading.value = true;
                await store.dispatch('verifyTraining', {
                    id: props.id,
                    itemId: itemId.value,
