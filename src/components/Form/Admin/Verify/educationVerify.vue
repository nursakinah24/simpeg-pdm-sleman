...
export default {
    ...
    setup(props, { emit }) {
        ...
        status_verifikasi.value = props.eduData.status_verifikasi;
        alasan_ditolak.value = props.eduData.alasan_ditolak || '';
        itemId.value = props.eduData.id;

        const handleSubmit = async () => {
            try {
                loading.value = true;
                await store.dispatch('verifyEducation', {
                    id: props.id,
                    itemId: itemId.value,
