...
export default {
    ...
    setup(props, { emit }) {
        ...
        status_verifikasi.value = props.posData.status_verifikasi;
        alasan_ditolak.value = props.posData.alasan_ditolak || '';
        itemId.value = props.posData.id;

        const handleSubmit = async () => {
            try {
                loading.value = true;
                await store.dispatch('verifyPosition', {
                    id: props.id,
                    itemId: itemId.value,
