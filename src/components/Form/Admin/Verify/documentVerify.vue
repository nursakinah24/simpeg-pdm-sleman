...
export default {
    ...
    setup(props, { emit }) {
        ...
        status_verifikasi.value = props.docData.status_verifikasi;
        alasan_ditolak.value = props.docData.alasan_ditolak || '';
        itemId.value = props.docData.id;

        const handleSubmit = async () => {
            try {
                loading.value = true;
                await store.dispatch('verifyDocument', {
                    id: props.id,
                    itemId: itemId.value,
