...
export default {
    ...
    setup(props, { emit }) {
        ...
        status_verifikasi.value = props.titleData.status_verifikasi;
        alasan_ditolak.value = props.titleData.alasan_ditolak || '';
        itemId.value = props.titleData.id;

        const handleSubmit = async () => {
            try {
                loading.value = true;
                await store.dispatch('verifyTitle', {
                    id: props.id,
                    itemId: itemId.value,
