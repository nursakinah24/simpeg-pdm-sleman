...
export default {
    ...
    setup(props, { emit }) {
        ...
        status_verifikasi.value = props.achieveData.status_verifikasi;
        alasan_ditolak.value = props.achieveData.alasan_ditolak || '';
        itemId.value = props.achieveData.id;

        const handleSubmit = async () => {
            try {
                loading.value = true;
                await store.dispatch('verifyAchievement', {
                    id: props.id,
                    itemId: itemId.value,
