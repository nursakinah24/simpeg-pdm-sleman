...
export default {
    ...
    setup(props, { emit }) {
        ...
        status_verifikasi.value = props.perfData.status_verifikasi;
        alasan_ditolak.value = props.perfData.alasan_ditolak || '';
        itemId.value = props.perfData.id;

        const handleSubmit = async () => {
            try {
                loading.value = true;
                await store.dispatch('verifyPerformance', {
                    id: props.id,
                    itemId: itemId.value,
